...
object Actions {
    ...
    fun openLoginIntent(context: Context) = internalIntent(context, "$prefix.login.open").apply { flags = Intent.FLAG_ACTIVITY_CLEAR_TASK or Intent.FLAG_ACTIVITY_NEW_TASK}
